...
import { X, Wallet, Copy, Check, Bell, Sliders, ArrowDownCircle, PlusCircle, LogOut, Trash2, Zap, CheckCircle2, AlertTriangle, Info, AlertOctagon } from 'lucide-react';
...
export const GlobalModals = () => {
  ...
  const copyAddress = () => {
    navigator.clipboard.writeText('0x00D3f92A8c14B9204c3D');
    setCopied(true);
      ...
      <div className="bg-[#0b0e17] border border-slate-800 rounded-2xl w-full max-w-lg shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800">
          <h3 className="text-base font-extrabold text-white flex items-center gap-2 font-mono">
            ...
            {activeModal === 'WALLET' && 'CONNECTED QUANT WALLET'}
        ...
        <div className="p-6 space-y-4 font-mono text-xs">
          ...
          {activeModal === 'WALLET' && (
            <div className="space-y-4">
              <div className="bg-[#060810] p-4 rounded-xl border border-slate-800 space-y-2">
                <span className="text-slate-500 block text-[10px] uppercase">Arbitrum Web3 Address</span>
                <div className="flex items-center justify-between bg-slate-900 p-2.5 rounded-lg border border-slate-800">
                  <span className="text-cyan-400 font-bold">0x00D3f92A8c14B9204c3D</span>
                  <button onClick={copyAddress} className="text-slate-400 hover:text-cyan-400">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-slate-900/60 p-3 rounded-xl border border-slate-800">
                  <span className="text-slate-400 block text-[10px]">Connected Network</span>
          ...
          {/* 3. NOTIFICATIONS MODAL (REAL LIVE NOTIFICATIONS LOG & CLEAR ACTION) */}
          ...
          {activeModal === 'LOGOUT' && (
            <div className="space-y-4 text-center">
              ...
              <div className="flex space-x-3 pt-2 font-sans">
                <button onClick={() => { alert('Session Paused'); closeModal(); }} className="flex-1 py-2.5 bg-rose-600 hover:bg-rose-500 text-white font-bold rounded-xl">
                  Confirm Exit
                </button>
